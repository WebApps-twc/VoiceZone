...
public class CallWaiting extends CommonFunctions 
{
                ...
                {
                	boolean statusdisabled = driver.findElement(By.xpath("(//input[@id='SelectedOption'])[1]")).isSelected();
...
public void execute(String br, WebDriver driver, String url, int loc, String name1) throws Exception {
      ...
      /*focusClick(driver, driver.findElement(By.id("SelectedOption")),br);
  	   
  	     focusClick(driver,driver.findElement(By.id("mainSubmitButton")),br);
  	    
			do{
				Thread.sleep(2000);
			}while(assertTrue(isElementPresent(driver.findElement(By.cssSelector("#progress > div.modal-body > div.modal-body.loader")))));*/
			
			boolean statusdisabled = driver.findElement(By.id("SelectedOption")).isSelected();
			...
			if(statusdisabled)
			{
				driver.findElement(By.xpath("(//input[@id='SelectedOption'])[1]")).click();
				 focusClick(driver,driver.findElement(By.id("mainSubmitButton")),br);
			...
			if(schk.equals("Pass"))
				schk =flowrun(br,driver, "(//input[@id='SelectedOption'])[2]");
			if(schk.equals("Pass"))
				schk =flowrun(br,driver, "(//input[@id='SelectedOption'])[1]");
			if(schk.equals("Pass"))
				schk =flowrun(br,driver,"(//input[@id='SelectedOption'])[3]");
			if(schk.equals("Pass"))
				schk =flowrun(br,driver,"(//input[@id='SelectedOption'])[1]");
			if(schk.equals("Pass"))
				schk =flowrun(br,driver,"(//input[@id='SelectedOption'])[2]");
