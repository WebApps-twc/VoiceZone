...
public void execute(String br, WebDriver driver, String url, int loc, String name1) throws Exception {
 ...
 System.out.println("qtest1");
    ...
    try {
       ...
       focusClick(driver,  driver.findElement(By.linkText("Call Forwarding: Unconditional")),br);
       ...
       focusClick(driver, driver.findElement(By.xpath("//html/body/div[3]/form/div/div[2]/a")),br);
	    ...
	    focusClick(driver,   driver.findElement(By.cssSelector("div.modal-footer > button.btn.btn-primary")),br);
                ...
                phoneline=driver.findElement(By.id("phonePullDownSelected")).getText();
                     ...
                     phoneline_ac=phoneline.substring(0,3);
                               phoneline_midtn=phoneline.substring(3,6);
                               phoneline_lastfour=phoneline.substring(6); 
