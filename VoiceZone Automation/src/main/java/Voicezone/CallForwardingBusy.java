      ...
      try
      {
    	  ...
    	  //selenium.open("https://voice.atgeng.timewarnercable.com/VZTTEST1");            
            focusClick(driver,driver.findElement(By.linkText("Settings")),br);
  	     	focusClick(driver,driver.findElement(By.xpath(".//*[@id='ContentRefresh']/div/div[6]/div/a")),br);
  	     	focusClick(driver,driver.findElement(By.xpath(".//*[@id='ContentRefresh']/ul/li[3]/a")),br);  	  
			...
			do{
  	     	...
  	     	Thread.sleep(2000);
			phoneline=phoneline=driver.findElement(By.id("phonePullDownSelected")).getText();	
