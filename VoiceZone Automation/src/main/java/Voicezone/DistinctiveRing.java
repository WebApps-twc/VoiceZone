...
public class DistinctiveRing extends CommonFunctions {
  ...
  public String flowrun(WebDriver driver,String br) throws Exception
  {
	  ...
	  if(status.equals(true))
	  {
		  ...
		  if(schk.equals("Pass"))
		  {
			  statusTracker(br,"Pass","Verify if disabling DistinctiveRing order is processed successfully","Order is successfully processed from "+ status +" to "+status1,"Order should be successfully processed");
		  }
		  else
		  {
	  ...
	  else if(status.equals(false))
	  {
		  ...
		  focusClick(driver,driver.findElement(By.xpath("/html/body/div[3]/form/div/div[3]/div[2]/div/div/div[3]/div/div[1]/div[1]/p[1]/input[1]")),br);
			  ...
			  if(schk.equals("Pass"))
			  {
				  statusTracker(br,"Pass","Verify if enabling DistinctiveRing order is processed successfully","Order is successfully processed from "+ status +" to "+status1,"Order should be successfully processed");
			  }
			  else
			  {
...
public String deleteall(WebDriver driver,String br) throws Exception
{
                ...
                int count =driver.findElements(By.xpath("//html/body/div[3]/form/div/div[3]/div[2]/div/div/div[3]/div/div/div[3]/table/tbody/tr")).size();
                ...
                if(count!=0)
                {
                                ...
                                boolean status = driver.findElement(By.id("Activated")).isEnabled();
...
logger.info("a");
		...
		/*if(schk.equals("Pass"))
			...
			if(schk.equals("Pass"))
			{
				status = driver.findElement(By.id("Activated")).isEnabled();
